  ...
  _createClass(ManagementAccount, [{
    ...
    value: function upgrade() {
      return this.connection.request({
        method: 'POST',
        path: "/a/".concat(this.clientId, "/").concat(this.constructor.collectionName, "/").concat(this.id, "/upgrade")
      })["catch"](function (err) {
    ...
    value: function downgrade() {
      return this.connection.request({
        method: 'POST',
        path: "/a/".concat(this.clientId, "/").concat(this.constructor.collectionName, "/").concat(this.id, "/downgrade")
      })["catch"](function (err) {
        return Promise.reject(err);
      });
    }
    ...
    value: function revokeAll(keep_access_token) {
      return this.connection.request({
        method: 'POST',
        path: "/a/".concat(this.clientId, "/").concat(this.constructor.collectionName, "/").concat(this.id, "/revoke-all"),
        body: {
    ...
    value: function ipAddresses() {
      return this.connection.request({
        method: 'GET',
        path: "/a/".concat(this.clientId, "/ip_addresses")
      })["catch"](function (err) {
        return Promise.reject(err);
      });
    }
    ...
    key: "tokenInfo",
    value: function tokenInfo(access_token) {
      return this.connection.request({
        method: 'POST',
        path: "/a/".concat(this.clientId, "/").concat(this.constructor.collectionName, "/").concat(this.id, "/token-info"),
        body: {
