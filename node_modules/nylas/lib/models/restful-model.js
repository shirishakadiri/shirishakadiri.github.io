...
function () {
  ...
  _createClass(RestfulModel, [{
    ...
    value: function saveEndpoint() {
      return "".concat(this.pathPrefix(), "/").concat(this.constructor.collectionName);
    ...
    key: "deleteRequestBody",
    value: function deleteRequestBody(params) {
      return {};
    } // deleteRequestOptions is used by delete(). Subclasses should override this method.

  }, {
    key: "deleteRequestOptions",
    value: function deleteRequestOptions(params) {
      return {
    ...
    value: function _save() {
      ...
      return this.connection.request({
        ...
        qs: params,
        path: this.id ? "".concat(this.saveEndpoint(), "/").concat(this.id) : "".concat(this.saveEndpoint())
      }).then(function (json) {
        _this.fromJSON(json);
